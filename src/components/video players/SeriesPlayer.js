...
const SeriesPlayer = props => {
  ...
  const episodes = props.playerData.episodes?.map(ep => {
    return (
      <div className={sClasses.seasonEpisode}>
        <div className={sClasses.episodeThumbnail}>
  ...
  return (
    ...
    >
      <div className={classes.moviePlayer}>
        ...
        {/* <button className={sClasses.episodesBtn}>
          <svg viewBox="0 0 17 12" width="17" height="12">
            <path fill="#fff" d="M0 0h17v2H0zM0 5h17v2H0zM0 10h17v2H0z"></path>
          </svg>
          ეპიზოდები
        </button>

        <div className={sClasses.episodesWrapper}>
          <div className={sClasses.closeIcon}>
          ...
          <div>
            <div className={sClasses.seasonsContainer}>
              <div className={sClasses.activeSeason}>
                <p>სეზონი 1</p>
              </div>
              <div>
                <p>სეზონი 1</p>
            ...
            <div>
              <div className={sClasses.seasonTitle}>
              ...
              <div className={sClasses.seasonEpisodes}>{episodes}</div>
            </div>
          </div>
        </div> */}
